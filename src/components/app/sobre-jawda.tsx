...
const valores = [
  {
    ...
    texto:
      "Pequenas ações repetidas mudam comportamento, não um manual guardado na gaveta.",
  },
  {
    icon: Lightbulb,
    titulo: "Ninguém protege o que não entende",
    texto:
      "Um sistema que ensina o porquê gera gente que decide contribuir, não só obedece.",
  },
  {
    icon: Languages,
  ...
  },
  {
    ...
    texto:
      "A tecnologia existe para facilitar comportamento humano, nunca para substituí-lo.",
  },
];
  ...
  return (
    <SobreCtx.Provider value={{ open, setOpen }}>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        >
          <DialogClose ref={closeRef} className="sr-only">Fechar</DialogClose>
